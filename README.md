...
<b>Note that 1</b>: I'm not the soley contributors of the following context. Many of following information are from my discussion with some researchers worked in this field and refer to some published works ([Jie Huang](https://jeffhj.github.io/) and [Yao Fu](https://franxyao.github.io/)).
...
<b>Note that (the implementation detail of Self-reward): We input the tasks (zero-shot) into the LLM and ask it whether the output is the correct answer. If not, a LLM provides feedback, and based on that feedback, executes the next round of inference.</b>
